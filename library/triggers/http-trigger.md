...
{% hint style="danger" %}
WayScript recommends [Authenticating using your API Key](http-trigger.md#authenticating-using-your-api-key), as it is more secure than Basic Authentication.
{% endhint %}
